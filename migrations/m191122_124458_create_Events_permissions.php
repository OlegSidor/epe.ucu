...
/**
 * Class m191122_124458_create_Events_permissions
 */
class m191122_124458_create_Events_permissions extends Migration
{
    /**
     * {@inheritdoc}
     * @throws Exception
    ...
    public function safeUp()
    {
        ...
        $view = $auth->createPermission('viewEvents');
        $create = $auth->createPermission('createEvents');
        $delete = $auth->createPermission('deleteEvents');
        $modify = $auth->createPermission('modifyEvents');
    ...
    public function safeDown()
    {
        ...
        $view = $auth->getPermission('viewEvents');
        $create = $auth->getPermission('createEvents');
        $delete = $auth->getPermission('deleteEvents');
        $modify = $auth->getPermission('modifyEvents');
